document.addEventListener('DOMContentLoaded', function() {
    ...
    function preencherFormulario(dados) {
        document.getElementById('empresa_nome').value = dados.estabelecimento.nome_fantasia || dados.razao_social;
        document.getElementById('empresa_endereco').value = `${dados.estabelecimento.logradouro}, ${dados.estabelecimento.numero}, ${dados.estabelecimento.complemento}, ${dados.estabelecimento.bairro}, ${dados.estabelecimento.cidade.nome}/${dados.estabelecimento.estado.sigla}, CEP ${dados.estabelecimento.cep}` || '';
        document.getElementById('empresa_descricao').value = dados.estabelecimento.atividade_principal.descricao || '';
    }
