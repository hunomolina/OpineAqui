...
<head>
    ...
    <style>
        <-- inseri style para alterar cores do link pular para o conteudo principal -->
        .skip-link {
            position: absolute;
            left: -9999px;
            top: auto;
...
<body>
    ...
    <-- inseri id="main-content" para compliance em acessibilidade-->
    <header>
    ...
    <footer class="footer-fixo" role="contentinfo">
        <-- inseri role="contentinfo" no footer para compliance em acessibilidade-->
